awesome = open("LICENSE.txt", "w+")
awesome.write("""________________________________________
    Awesome License V0.0.1
    https://drive.google.com/file/d/19vENl5LNJ0iupriwEf3b3yIzeRXXdN1P/view
    Rights Reserved <year> <name>
...
0. License
shall mean the rules to follow/listen to... you are currently reading the License right now.
1. Rights/Rights Reserved
